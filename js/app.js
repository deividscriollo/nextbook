...
app.factory('Empresa', function($resource) {
    return $resource("http://172.30.1.14/appnext/public/registroEmpresas/:id", {
        id: "@id"
    });
});

app.factory('Persona', function($resource) {
    return $resource("http://172.30.1.14/appnext/public/registroPersonas/:id", {
        id: "@id"
    });
});
...
return $resource('http://172.30.1.14/appnext/public/login', {}, {
    ingresar: {
        method: 'POST',
        isArray: false,
...
return $resource('http://172.30.1.14/appnext/public/logoutE', {}, {
    salir: {
        method: 'POST',
        isArray: false,
       params: {token: $localStorage.token}
...
return $resource('http://172.30.1.14/appnext/public/getsucursales', {}, {
    get: {
        method: 'GET',
        isArray: false,
       params: {token: $localStorage.token}
...
return $resource('http://172.30.1.14/appnext/public/readFacturas', {}, {
    get: {
        method: 'GET',
        isArray: false,
       params: {token: $localStorage.token}
...
return $resource('http://172.30.1.14/appserviciosnext/public/cosultarMovil', {}, {
    validar: {
        method: 'POST',
        isArray: false,
       // params: {token: $localStorage.token}
